...
class FullyAnnotatedDataset(Dataset):
    ...
    def __init__(self, images, masks, boxes, labels, transform=None, set_boxes_to_label = False, unsqueeze_mask = True):
        """
        ...
        self.unsqueeze_mask = unsqueeze_mask
